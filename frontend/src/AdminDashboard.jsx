...
function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          "https://product-service-pjzd.onrender.com/product/"
        );
  ...
  const deleteUser = async (id) => {
    try {
      await axios.delete(
        `https://gaming-store-using-microservices-1.onrender.com/user/${id}`
      );
  ...
  const deleteCoupon = async (id) => {
    try {
      await axios.delete(
        `https://coupon-service-hf15.onrender.com/coupon/${id}`
      );
  ...
  const deleteProduct = async (id) => {
    try {
      await axios.delete(
        `https://product-service-pjzd.onrender.com/product/${id}`
      );
  ...
  const updateProduct = async () => {
    try {
      const response = await axios.put(
        `https://product-service-pjzd.onrender.com/product/${editProductId}`,
        editProductFields
      );
